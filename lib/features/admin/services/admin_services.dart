...
import 'package:financeLine/constants/error_hundling.dart';
import 'package:financeLine/constants/global_variables.dart';
import 'package:financeLine/constants/utils.dart';
import 'package:financeLine/models/product.dart';
import 'package:financeLine/models/user.dart';
...
class AdminServices {
  ...
  void sellProduct({
    ...
    try {
      ...
      http.Response res = await http.post(Uri.parse('$uri/api/add-product'),
          headers: {
